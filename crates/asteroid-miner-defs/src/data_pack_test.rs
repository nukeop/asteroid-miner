mod tests {
    ...
    fn load_base_data_pack_from_real_files() {
        let skills =
            load_skills(include_str!("../../../packages/game/data/base/skills.json")).unwrap();
        let traits =
            load_traits(include_str!("../../../packages/game/data/base/traits.json")).unwrap();
        ...
        .unwrap();
        let tags = load_tags(include_str!("../../../packages/game/data/base/tags.json")).unwrap();
